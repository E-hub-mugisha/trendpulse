                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        disabled={processing}
                                        className="mt-4 w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 p-4 text-sm text-black outline-none transition placeholder:text-gray-400 focus:border-[#0A599E] focus:bg-white focus:ring-2 focus:ring-[#0A599E]/25 disabled:opacity-50"
                                    />
                                    ...
                                    <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
                                        ...
                                        {/* Image */}
                                        <label
                                            className={`inline-flex cursor-pointer items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-xs font-bold text-gray-700 transition hover:border-[#0A599E] hover:text-[#0A599E] ${
                                                processing
                    ...
                    <div className="mb-8 overflow-hidden rounded-3xl border border-gray-200 bg-black text-white">
                        ...
                        <div className="p-6 sm:p-8">
                            ...
                            <p className="mt-2 text-sm text-gray-400">
                                Sign in to post, like, and
                                comment with the TrendPulse
                                community.
                            </p>
