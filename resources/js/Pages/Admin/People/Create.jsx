// resources/js/Pages/Admin/People/Create.jsx
...
export default function Create({ categories }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post('/admin/people', { forceFormData: true });
    };
    ...
    return (
        <AdminLayout title="Add People Story">
            ...
            <div className="mx-auto max-w-3xl">
                ...
                <p className="mt-1 text-sm text-gray-500">
                    Share a real story about relationships, love, or family.
                </p>
                ...
                <form onSubmit={submit} className="mt-8 space-y-6 rounded-2xl border border-gray-100 bg-white p-6 sm:p-8">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g. Married, Engaged, Single"
                                className="mt-2 block w-full rounded-xl border-0 bg-gray-100 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-black"
                            />
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-gray-100 pt-6">
                        ...
                        >
                            ...
                            {processing ? 'Saving…' : 'Publish Story'}
                        </button>
                    </div>
