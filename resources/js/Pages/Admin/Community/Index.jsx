        ...
        <AdminLayout title="Community">
            ...
            <div>
                ...
                <div className="mb-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div
                        className={`rounded-2xl border bg-white p-5 ${stats.flagged > 0 ? "border-red-200" : "border-gray-100"}`}
                    >
                        <p className="text-xs font-medium text-gray-400">
                            Flagged
                        </p>
                ...
                <div className="mb-5 flex flex-wrap items-center gap-3">
                    <form
                        ...
                        className="flex min-w-[220px] flex-1 items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5"
                    >
                        <Search
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
                    <div className="w-full max-w-sm rounded-2xl bg-white p-6">
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                            This post and all its comments will be permanently
